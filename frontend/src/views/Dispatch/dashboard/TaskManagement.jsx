...
import DeleteTaskModal from '../../../components/Dispatch/dashboard/task/DeleteTaskModal';
import UpsertTaskModal from '../../../components/Dispatch/dashboard/task/UpsertTaskModal';
        ...
        <div className="bg-gray-50 p-4 h-[90vh] sm:p-6 lg:p-8">
            ...
            <div className="h-full overflow-y-auto mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600">Manage your Permissions and their details</p>
                </div>
                ...
                {isLoading ? (
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600 mb-4">
                            {searchTerm ? 'Try adjusting your search terms.' : 'Get started by adding your first Permission.'}
                        </p>
                        {!searchTerm && (
                            <button
                                onClick={() => setIsAddModalOpen(true)}
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h3 className="font-semibold text-gray-900">
                                                    {task.taskname || 'Unnamed Permission'}
                                                </h3>
            ...
            <UpsertTaskModal
                ...
                task={selectedTask}
                isLoading={isLoading}
                title={isEditModalOpen ? 'Edit Permssion' : 'Add New Permssion'}
            />
